...
volatile unsigned int __attribute__ ((aligned (8))) dsp_data_stack[96 + (LCL_MAP_PIX * LCL_MAP_PIX)];
...
0x00000000, 0x00001E02, 0x01968000, 0x14041E01, 0xD31000B7, 0x00069E04, 
